        ...
        <div className="relative">
            {searchValue && <div className="bg-(--main-bg) p-1 w-[300px] neu__norm rounded-3xl absolute top-11 start-[-50px] z-50">
                <div className="p-3 neu__inner rounded-3xl flex flex-col gap-3">
                    ...
                    <div className="flex justify-between items-center px-5"><span className="text-[10px]">Tracks</span><Link href={'#'} className="text-[8px] text-(--alt-text)">view all</Link></div>
                    {/* loading tracks */}
                    ...
                    <div className="flex justify-between items-center px-5"><span className="text-[10px]">Playlists</span><Link href={'#'} className="text-[8px] text-(--alt-text)">view all</Link></div>
                    {/* loading playlist */}
